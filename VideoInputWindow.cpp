...
VideoInputWindow::VideoInputWindow()
{

}

VideoInputWindow::VideoInputWindow(Manager_window* m_manager)
{
...
void VideoInputWindow::accept()
{
    ...
    */
    ...
    create_video(figcaption->text(),lien->text());
    is_ready=true;
    m_manager_window->open_window("edit_window");
    emit update();
}

void VideoInputWindow::reject()
{
    m_manager_window->open_window("edit_window");
}

void VideoInputWindow::create_video(QString figcaption,QString lien)
{
    m_texte=QString("\n<figure>\n"
                      "<picture>\n"
                      "<!-- AVIF -->\n"
